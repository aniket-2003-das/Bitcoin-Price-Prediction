...
if __name__ == "__main__":
    ...
    # preprocessor = SingleCoinPreprocessor(prediction_days=180)
    ...
    # # Step 4: Generate sequences for both train and test
    # seq_generator = SingleCoinSequenceGenerator(lookback=14)
    # # Use scaled training data from the preprocessor output
    # scaled_train = processed_data["scaled_train"]
    # scaled_test = processed_data["scaled_test"]
    # # Generate training sequences
    # X_train, y_train = seq_generator.generate_sequences(scaled_train)
    # print("X_train shape:", X_train.shape)
    # print("y_train shape:", y_train.shape)
    # # Generate test sequences
    # X_test, y_test = seq_generator.generate_sequences(scaled_test)
    ...
    # history = trainer.train(X_train, y_train, X_val, y_val, epochs=600)
    ...
    # predictions = predictor.predict(processed_data, num_future_days=14)
    # print(predictions)
